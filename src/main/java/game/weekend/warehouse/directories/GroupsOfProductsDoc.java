...
public class GroupsOfProductsDoc extends Document {
	 ...
	 */
	public GroupsOfProductsDoc(int id, int mode, FrameManager parentFrameManager) {
	...
	public void initComponents() {
		...
		DocData docData;
		try {
			docData = new GroupsOfProductsData(getId(), getMode(), this);
		} catch (Exception e) {
		...
		// Заголовок окна
		showTitle(Loc.get("group_of_products"), "name");
