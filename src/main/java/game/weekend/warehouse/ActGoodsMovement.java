...
public class ActGoodsMovement extends AbstractAction {

	public ActGoodsMovement(MainFrame mainFrame) {
		this.mainFrame = mainFrame;

		putValue(Action.NAME, Loc.get("goods_movement"));
		putValue(Action.SHORT_DESCRIPTION, Loc.get("goods_movement"));
